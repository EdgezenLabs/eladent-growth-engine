...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Eladent Consulting — Dental Billing & Revenue Cycle Management" },
      { name: "description", content: "HIPAA-compliant dental billing, insurance verification, credentialing and RCM for US dental practices. Maximize collections and reduce denials with Eladent Consulting." },
      { property: "og:title", content: "Eladent Consulting — Dental Billing & RCM" },
      { property: "og:description", content: "End-to-end dental billing and consulting to maximize collections, reduce denials and scale your practice." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "/",
          description: "Dental billing, RCM and practice consulting for US dental practices.",
          areaServed: "United States",
          contactPoint: { "@type": "ContactPoint", telephone: "+1-800-555-0199", contactType: "Sales" },
        }),
      },
    ],
  }),
